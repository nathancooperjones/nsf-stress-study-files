...
stroop_df <- read_csv("~/Desktop/nsf-stress-study-files/@Datasets/survey-reports/color_test_score.csv", col_types = cols())
...
```{r echo = FALSE, warning = FALSE, message = FALSE} 
measure_vec <- c("PP", "HR", "BR", "D.EDA", "D.HR") 
cond <- "IH" 
