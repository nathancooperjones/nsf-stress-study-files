...
\newpage 
Linear Modelling for Criterion Score 
----- 
...
result_df <- read_csv("~/Desktop/testing_df.csv", col_types = cols()) 
result_df <- result_df %>% 
...
essay_score_df <- read_csv("~/Desktop/essay_score_master_file.csv", col_types = cols()) 
...
nlp_df <- read_csv("~/Desktop/essay_nlp_results.csv", col_types = cols()) 
