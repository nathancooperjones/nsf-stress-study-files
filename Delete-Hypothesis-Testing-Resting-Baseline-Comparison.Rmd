...
plot2 <- function(testing_df, test_type, col, cond, pdf_file_name) { 
  ...
  # print(gg) 
  # save_plot("@@Test.pdf", gg, base_height = 10, base_width = 15) 
...
for (col in measure_vec) { 
  ...
  if (!is.na(lst)) { 
    ...
    plot2(as.tibble(lst[[1]]), as.character(lst[[2]]), as.character(lst[[3]]), as.character(lst[[4]]), 'IH_boxplot.pdf') 
...
for (col in measure_vec) { 
  lst <- test_time(cond, col) 
  if (!is.na(lst)) { 
    plot2(as.tibble(lst[[1]]), as.character(lst[[2]]), as.character(lst[[3]]), as.character(lst[[4]]), 'BH_boxplot.pdf') 
    # interpret_results_after(cond, col) 
    plot.new() 
  } 
} 
...
for (col in measure_vec) { 
  lst <- test_time(cond, col) 
  if (!is.na(lst)) { 
    plot2(as.tibble(lst[[1]]), as.character(lst[[2]]), as.character(lst[[3]]), as.character(lst[[4]]), 'IL_boxplot.pdf') 
    # interpret_results_after(cond, col) 
    plot.new() 
  } 
} 
...
for (col in measure_vec) { 
  lst <- test_time(cond, col) 
  if (!is.na(lst)) { 
    plot2(as.tibble(lst[[1]]), as.character(lst[[2]]), as.character(lst[[3]]), as.character(lst[[4]]), 'BL_boxplot.pdf') 
    # interpret_results_after(cond, col) 
    plot.new() 
  } 
} 
