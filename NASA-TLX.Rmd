...
# nasa_df <- read_csv("~/Desktop/Stress_Project/Post-SurveyExport.csv", col_types = cols())
nasa_df <- read_csv("T:/Google Drive/University of Houston/CS - UH/@Research - CPL/@Projects/NsfStressDataCuration/survey-reports/Pre-SurveyExport.csv", col_types = cols()) 
